...
async function walletSync() {
  ...
  //TODO replace with our node
  //https://doge.getblock.io/6350ed17-8246-402f-a64a-423c743eb76e/mainnet/ maybe?
  let response = await axios({
    method: 'get',
    url: `https://dogechain.info/api/v1/address/unspent/${wallet.address}`,
...
function inscribe(wallet, address, contentType, data) {
  ...
  while (inscription.chunks.length) {
    ...
    //  node . drc-20 mint D7gFEMYJH9HjZ9sT6vydarquYjXjCkwH6p x100 1000000000000000 12
